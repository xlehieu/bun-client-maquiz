...
type OneNNAnswerProps = {
  form: FormInstance<BodyCreateQuestionQuiz>;
};
  ...
  return (
    <React.Fragment>
      <div className="flex flex-col">
        ...
        <Form.Item<BodyCreateQuestionQuiz> name="questionContent">
              ...
              {fields.map(({ key, name }, index) => (
                <div key={key} className="flex flex-col mt-4">
                  <div className="flex justify-between content-center">
                    <div className="flex">
                      {form.getFieldValue("questionType") === "01" ? (
                        <Form.Item<BodyCreateQuestionQuiz["answers"]>
                          name={[name, "isCorrect"]}
