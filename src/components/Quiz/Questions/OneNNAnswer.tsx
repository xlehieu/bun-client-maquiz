        ...
        <div className="space-y-8">
            ...
            <section className="animate-in fade-in slide-in-from-top-4 duration-500">
                <div className="flex items-center  mb-3 justify-between">
                    ...
                    <div className="text-xs font-bold text-slate-400 bg-slate-100 px-3 py-1 rounded-full italic">
                        {questionType === 1 ? 'Dạng câu hỏi một đáp án' : 'Dạng câu hỏi nhiều đáp án'}
                    </div>
                </div>
            ...
            <section>
                <div className="flex items-center justify-between mb-6">
                    ...
                    <Tag color="blue" className="rounded-full px-3 font-bold border-none bg-blue-50 text-blue-500">
                        {questionType === 1 ? 'Chọn một đáp án đúng' : 'Chọn nhiều đáp án đúng'}
                    </Tag>
                </div>
                                ...
                                >
                                    <div className="flex items-center justify-between mb-4">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <Form.Item name={[name, 'isCorrect']} valuePropName="checked" noStyle>
                                                {questionType === 1 ? (
                                    ...
                                    >
                                        <TextEditor placeholder={`Nhập nội dung cho đáp án ${index + 1}...`} />
                                    </Form.Item>

                                    {/* Decorator checkmark khi được chọn đúng */}
                                    <Form.Item shouldUpdate noStyle>
                                        {() => {
                                            const isCorrect = form.getFieldValue(['answers', name, 'isCorrect']);
                                            return (
                                                isCorrect && (
