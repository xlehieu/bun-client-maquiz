...
const TakeSingleMultipleAnswersQuestion = () => {
    const {
        currentQuizTakeDetail: currentQuizDetail,
    ...
    return (
        <div className="flex flex-col h-full bg-white p-4 md:p-6">
          ...
          ${statusClass} /* Áp dụng class đúng/sai trực tiếp vào card */
          ${!statusClass && isChecked ? 'border-blue-500 bg-blue-50' : ''} 
          ${!statusClass && !isChecked ? 'border-slate-100 bg-white hover:border-slate-300 hover:shadow-md' : ''}
        `}
                        >
...
export default TakeSingleMultipleAnswersQuestion;
