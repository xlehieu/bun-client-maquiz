...
import { faChalkboardTeacher, faUserGraduate, faArrowRight } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <div className="group w-full bg-white transition-all duration-300 border border-slate-100 rounded-[24px] overflow-hidden hover:shadow-2xl hover:shadow-slate-200/50 hover:-translate-y-1 relative h-64 flex flex-col">
            ...
            <div className="relative h-28 w-full overflow-hidden shrink-0">
                ...
                >
                    <FontAwesomeIcon icon={isMyClassroom ? faChalkboardTeacher : faUserGraduate} className="mr-1.5" />
            ...
            <div className="relative p-4 flex flex-col flex-1">
                ...
                <div className="mt-2 pr-10">
                    ...
                    <p className="text-xs font-medium text-slate-400 mt-1 tracking-tight">
                        Mã lớp: <span className="text-slate-600 font-bold uppercase">{classroom?.classCode}</span>
                    </p>
                </div>
                ...
                <div className="mt-auto pt-4 flex items-center justify-between border-t border-slate-50">
                    <div className="flex flex-col">
                        ...
                        {isMyClassroom && <span className="text-xs font-bold text-camdat italic">Đang quản lý</span>}
                    </div>
                    ...
                    <Button
                        ...
                        shape="circle"
                        size="small"
                        icon={<FontAwesomeIcon icon={faArrowRight} className="text-[10px]" />}
                        onClick={handleNavigate}
