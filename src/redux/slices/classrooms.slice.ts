import { getClassroomDetail, getUserClassrooms } from '@/api/classrooms.service';
...
export const fetchMyClassroom = createAsyncThunk('classroom/fetchMyClassroom', async () => {
    try {
...
export const fetchClassroomDetail = createAsyncThunk('classroom/fetchClassroomDetail', async (classCode: string) => {
    try {
